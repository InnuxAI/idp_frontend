...
export const KnowledgeGraph = forwardRef<KnowledgeGraphHandle, KnowledgeGraphProps>(
    function KnowledgeGraph({ data, onNodeClick, onNodeRightClick }, ref) {
        ...
        // Legend collapse state - starts collapsed
        ...
        // Expose selectNodeById method to parent via ref
        useImperativeHandle(ref, () => ({
            selectNodeById: (nodeId: string) => {
                const node = gData.nodes.find((n: GraphNode) => n.id === nodeId);
                if (node) {
                    // Select the node
                    setSelectedNodes(new Set([nodeId]));

                    // Center and zoom to the node (with slight delay for coordinates to be set)
                    setTimeout(() => {
        ...
        return (
            <div ref={containerRef} className="w-full h-full bg-slate-50 dark:bg-zinc-900/50 relative overflow-hidden rounded-xl border border-gray-200 dark:border-zinc-800 shadow-inner dark:shadow-none">
                ...
                <div className="absolute bottom-4 left-4 flex flex-col-reverse items-start gap-2">
                    {/* Legend Toggle Button - stays at bottom */}
                    <button
                        onClick={() => setIsLegendExpanded(!isLegendExpanded)}
                        className={`
                            flex items-center gap-2 px-3 py-2
                            bg-white/90 dark:bg-zinc-900/90 backdrop-blur-sm
                            rounded-lg border border-gray-200 dark:border-zinc-800 shadow-md
                            text-xs font-medium text-gray-700 dark:text-zinc-300
                            transition-all duration-300 ease-out
                    ...
                    <AnimatePresence mode="wait">
                        {isLegendExpanded && (
                            <motion.div
                                ...
                                className="flex flex-col gap-2 p-3 bg-white/80 dark:bg-zinc-900/90 backdrop-blur-sm rounded-lg border border-gray-100 dark:border-zinc-800 shadow-sm text-xs font-medium select-none text-gray-700 dark:text-zinc-300"
                            >
                                <motion.div
                                ...
                                >
                                    <div className="w-3 h-3 rounded-full bg-[#7C3AED]"></div> MSA
                                </motion.div>
                                <motion.div
                                    className="flex items-center gap-2"
                                    initial={{ opacity: 0, y: 8 }}
                                ...
                                >
                                    <div className="w-3 h-3 rounded-full bg-[#2563EB]"></div> SOW
                                </motion.div>
                                <motion.div
                                    className="flex items-center gap-2"
                                    initial={{ opacity: 0, y: 8 }}
                                ...
                                >
                                    <div className="w-3 h-3 rounded-full bg-[#059669]"></div> Invoice
                                </motion.div>
                                <motion.div
                                    className="flex items-center gap-2"
                                    initial={{ opacity: 0, y: 8 }}
                                ...
                                >
                                    <div className="w-3 h-3 rounded-full bg-[#D97706]"></div> Addendum
                                </motion.div>
                                <motion.div
                                    className="flex items-center gap-2"
                                    initial={{ opacity: 0, y: 8 }}
                                ...
                                >
                                    <div className="w-3 h-3 rounded-full bg-[#DC2626]"></div> NDA
                                </motion.div>
                                <motion.div
                                    className="flex items-center gap-2"
                                    initial={{ opacity: 0, y: 8 }}
                                ...
                                >
                                    <div className="w-3 h-3 rounded-full bg-[#49ca38ff]"></div> Organization
                                </motion.div>
                                <motion.div
                                    className="flex items-center gap-2"
                                    initial={{ opacity: 0, y: 8 }}
                                ...
                                >
                                    <div className="w-3 h-3 rounded-full bg-[#DB2777]"></div> Visiting Card
                                </motion.div>
                                <motion.div
                                    className="flex items-center gap-2"
                                    initial={{ opacity: 0, y: 8 }}
                                ...
                                >
                                    <div className="w-3 h-3 rounded-full bg-[#0891B2]"></div> Brochure
                                </motion.div>
                                <motion.div
                                    className="mt-2 text-gray-400 dark:text-zinc-500 text-[10px] leading-tight"
                                    initial={{ opacity: 0, y: 8 }}
                                    animate={{ opacity: 1, y: 0 }}
